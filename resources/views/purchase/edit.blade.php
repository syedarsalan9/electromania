                        ...
                        <div class="row">
                            <div class="col-md-12">
                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <td class="discount"><!-- {{ number_format((float)$product_purchase->discount, 2, '.', '') }} -->0</td>
                                                ...
                                                <tfoot class="tfoot active">
                                                    ...
                                                    <th id="total-discount">{{ $lims_purchase_data->order_discount }}</th>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="hidden" name="total_discount" value="{{$lims_purchase_data->order_discount}}" />
                                        </div>
                                    </div>
                                    <?php
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="hidden" name="total_discount" value="{{$percent}}" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                ...
                                <div class="row mt-5">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="order_discount" class="form-control order_discount" value="{{$lims_purchase_data->order_discount}}" step="any" />
                                        </div>
                                    </div>
                                    <?php
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="order_discount_percentage" class="form-control order_discount_percentage" value="{{$percent}}" step="any" />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
