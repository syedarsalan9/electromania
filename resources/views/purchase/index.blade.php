        ...
        <div class="container mt-3 pb-2 border-bottom">
            ...
            <table class="table table-bordered product-purchase-list">
                <tr>
                        ...
                        <td>Qty</td>
                        <td>{{trans('file.Unit Cost')}}</td>
                        <td>{{trans('file.Tax')}}</td>
                        <td>{{trans('file.Discount')}}</td>
                        <td>{{trans('file.Subtotal')}}</td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table class="table table-hover payment-list">
                    <thead>
                        <tr>
                            <thead>{{trans('file.date')}}</thead>
                            <thead>{{trans('file.Reference No')}}</thead>
                            <thead>{{trans('file.Account')}}</thead>
                            <thead>{{trans('file.Amount')}}</thead>
                            <thead>{{trans('file.Paid By')}}</thead>
                            <thead>{{trans('file.action')}}</thead>
                        </tr>
                    </thead>
                    <tbody>
                    </tbody>
