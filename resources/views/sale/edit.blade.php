                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="hidden" name="total_discount_percentage" value="{{$percent}}" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        @endif
                                        <div class="form-group">
                                            <input type="hidden" name="grand_total" value="{{$lims_sale_data->total_price + $tax - $lims_sale_data->order_discount}}" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="order_discount" class="form-control order_discount" value="{{$lims_sale_data->order_discount}}" step="any" />
                                        </div>
                                    </div>
                                    <?php
