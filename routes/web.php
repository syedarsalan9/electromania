...
Route::group(['middleware' => ['auth', 'active']], function() {
	...
	Route::get('sales/txn_invoice/{id}', 'SaleController@genInvoiceTxn')->name('sale.txninvoice');
	Route::get('sales/gen_invoice/{id}', 'SaleController@genInvoice')->name('sale.invoice');
	Route::get('sales/gen_pdf/{id}', 'SaleController@genPdf')->name('sale.pdf-invoice');
	Route::get('sales/gen_txn_pdf/{id}', 'SaleController@genTxnPdf')->name('sale.txnpdf-invoice');
