                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="hidden" name="total_discount_percentage" value="<?php echo e($percent); ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            ?>
                                            <input type="hidden" name="order_tax" value="<?php echo e($tax); ?>"/>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        ...
                                        <?php endif; ?>
                                        <div class="form-group">
                                            <input type="hidden" name="grand_total" value="<?php echo e($lims_sale_data->total_price + $tax - $lims_sale_data->order_discount); ?>" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="order_discount" class="form-control order_discount" value="<?php echo e($lims_sale_data->order_discount); ?>" step="any" />
                                        </div>
                                    </div>
                                    <?php
...
var tax = (parseFloat($('input[name="total_price"]').val()).toFixed(2) * $('input[name="order_tax_rate_hidden"]').val())/100;
$('#order_tax').text(tax);
...
var discount = parseFloat($('input[name="order_discount"]').val()).toFixed();

$('#shipping_cost').text(parseFloat($('input[name="shipping_cost"]').val()).toFixed(2));
$('#grand_total').text(parseFloat(total) + parseFloat(tax) - discount);
