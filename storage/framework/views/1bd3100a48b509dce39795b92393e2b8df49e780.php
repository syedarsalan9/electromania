        ...
        <div class="container mt-3 pb-2 border-bottom">
            ...
            <table class="table table-bordered product-purchase-list">
                <tr>
                        ...
                        <td>Qty</td>
                        <td><?php echo e(trans('file.Unit Cost')); ?></td>
                        <td><?php echo e(trans('file.Tax')); ?></td>
                        <td><?php echo e(trans('file.Discount')); ?></td>
                        <td><?php echo e(trans('file.Subtotal')); ?></td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table class="table table-hover payment-list">
                    <thead>
                        <tr>
                            <thead><?php echo e(trans('file.date')); ?></thead>
                            <thead><?php echo e(trans('file.Reference No')); ?></thead>
                            <thead><?php echo e(trans('file.Account')); ?></thead>
                            <thead><?php echo e(trans('file.Amount')); ?></thead>
                            <thead><?php echo e(trans('file.Paid By')); ?></thead>
                            <thead><?php echo e(trans('file.action')); ?></thead>
                        </tr>
                    </thead>
                    <tbody>
                    </tbody>
...
<script type="text/javascript">
    ...
    function purchaseDetails(purchase){
        ...
        $.get('purchases/product_purchase/' + purchase[3], function(data){
            ...
            console.log("Total Amount "+purchase[20]);
            console.log("Discount "+purchase[18]);
            var differenceCal = purchase[20] - purchase[18];
            console.log("Difference "+differenceCal);
            var PercentageAmount = purchase[20] - differenceCal;
            console.log("PercentageAmount "+PercentageAmount);
            var percent = (PercentageAmount / purchase[20]) * 100;
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td colspan=4><strong><?php echo e(trans("file.Order Tax")); ?>:</strong></td>';
            cols += '<td>(' + purchase[17] + '%)' + '</td>';
            newRow.append(cols);
            newBody.append(newRow);

            var newRow = $("<tr>");
            cols = '';
            cols += '<td colspan=4><strong><?php echo e(trans("file.Order Discount")); ?>:</strong></td>';
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td colspan=4><strong>Discount Percentage:</strong></td>';
            cols += '<td>' + percent + '</td>';
            newRow.append(cols);
            newBody.append(newRow);
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td colspan=4><strong><?php echo e(trans("file.Paid Amount")); ?>:</strong></td>';
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td colspan=4><strong><?php echo e(trans("file.Due")); ?>:</strong></td>';
