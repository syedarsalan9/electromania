                                                    ...
                                                    <tr height="20"></tr>
                                                        <tr>
                                                            <td style="text-align: center; font-size: 14px;color: #000">
                                                                <?php echo e($payment_data->paying_method ? $payment_data->paying_method : "N/A"); ?>

                                                            </td>
                                                            <td style="text-align: center;font-size: 14px;color: #000">
                                                                <?php echo e(number_format((float)$payment_data->amount, 2, '.', '') ? number_format((float)$payment_data->amount, 2, '.', '') : "N/A"); ?>

                                                            </td>
                                                            <td style="text-align: center;font-size: 14px;color: #000">
                                                                <?php echo e(number_format((float)$payment_data->change, 2, '.', '') ? number_format((float)$payment_data->change, 2, '.', '') : "N/A"); ?>
