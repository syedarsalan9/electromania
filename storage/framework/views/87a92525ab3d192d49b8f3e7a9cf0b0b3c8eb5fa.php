        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="text-center mb-5">
                    <button type="submit" class="btn btn-danger btn-rounded btn-fw pr-5 pl-5"><?php echo e(trans('file.update')); ?></button>
                </div>
                <?php echo Form::close(); ?>
    ...
    <div class="modal fade" id="add-warehouse" tabindex="-1" role="dialog" aria-labelledby="add-warehouse" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="text-center mb-5">
                    <input type="submit" value="<?php echo e(trans('file.submit')); ?>" class="btn btn-danger btn-rounded btn-fw pr-5 pl-5">
                </div>
    ...
    <div class="modal fade" id="add-biller" tabindex="-1" role="dialog" aria-labelledby="add-biller" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="text-center mb-5">
                    <button type="submit" class="btn btn-danger btn-rounded btn-fw pr-5 pl-5"><?php echo e(trans('file.add')); ?></button>
                </div>
                <?php echo Form::close(); ?>
