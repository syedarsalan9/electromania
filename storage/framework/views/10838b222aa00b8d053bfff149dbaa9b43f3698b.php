                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label><strong>NTN Number</strong></label>
                                    <input type="text" name="tax_no" class="form-control" value="<?php echo e($lims_customer_data->tax_no); ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label><strong>STRN Number</strong></label>
                                    <input type="text" name="stnt_number" class="form-control" value="<?php echo e($lims_customer_data->stnt_number); ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
