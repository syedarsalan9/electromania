                        ...
                        <div class="row">
                            <div class="col-md-12">
                                        ...
                                        <div class="table-responsive mt-3">
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                    <tr data-id="<?php echo e($product_data->code); ?>">
                                                    <?php 
                                                    ...
                                                    ?>
                                                        ...
                                                        <td class="discount"><!-- <?php echo e(number_format((float)$product_purchase->discount, 2, '.', '')); ?> -->0</td>
                                                 ...
                                                 <?php
                                                    ...
                                                    $differenceCal = $lims_purchase_data->total_cost - $lims_purchase_data->order_discount;
                                                    //dd($differenceCal,,$lims_purchase_data->order_discount);
                                                    $PercentageAmount = $lims_purchase_data->total_cost - $differenceCal;
                                                    $percent = ($PercentageAmount / $lims_purchase_data->total_cost) * 100;
                                                ...
                                                <tfoot class="tfoot active">
                                                    ...
                                                    <th id="total-discount"><?php echo e($lims_purchase_data->order_discount); ?></th>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="hidden" name="total_discount" value="<?php echo e($lims_purchase_data->order_discount); ?>" />
                                        </div>
                                    </div>
                                    <?php
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="hidden" name="total_discount" value="<?php echo e($percent); ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                ...
                                <div class="row mt-5">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="order_discount" class="form-control order_discount" value="<?php echo e($lims_purchase_data->order_discount); ?>" step="any" />
                                        </div>
                                    </div>
                                    <?php
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="order_discount_percentage" class="form-control order_discount_percentage" value="<?php echo e($percent); ?>" step="any" />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
